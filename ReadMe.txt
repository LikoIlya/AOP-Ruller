...
Для встановлення програми потрібно запутити "setup.exe" та слідувати інструкціям встановлювача. Він сам встановить необхідні файли та програми (див. "Додаткові програми").
___________________________________________________________
